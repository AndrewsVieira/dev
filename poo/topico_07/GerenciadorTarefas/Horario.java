...
public class Horario {
	...
	// Obtem o número de horas completas fazendo a divisão inteira do número de
	// segundos por 3600, que corresponde ao número de segundos em uma hora(60
	// minutos * 60 segundos).
	...
	// Obtem o número de minutos completos extraindo o número de horas completas
	// (resto da divisão) e fazendo a divisão por 60.
	...
	// Obtem o número de segundos completos extraindo o número de horas e minutos
	// completos (resto da divisão).
