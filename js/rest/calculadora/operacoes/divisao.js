...
operacao.get('/', [
    ...
    check('b', "'b' é parâmetro obrigatório").trim().escape().notEmpty().isInt().withMessage("Parâmetro 'b' não é número").toInt().custom((b) => {
        return b != 0;
    }).withMessage("Não é possível dividir por 0 (zero).")
], (req, res) => {
